package com.infomovil.infomovil.gui.widget.sortlist;
...
public class DragSortListView extends ListView {
	...
	private EnableContactListener mEnableContactListener;
	...
	public DragSortListView(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			if (useDefault) {
				...
				//Contactos
				int clickUpdateId = a.getResourceId(R.styleable.DragSortListView_click_update_id, 0);
...
//			}
	...
	public void setEnableContactListener(EnableContactListener l) {
		mEnableContactListener = l;
	}
	...
	/**
	 * Implementacion para el manejo del activado y desactivado de contactos
	 * 
	 */
	
	public interface EnableContactListener {
